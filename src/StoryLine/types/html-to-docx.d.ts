declare module 'html-to-docx' {
    interface Margins {
        /**
         * top <Number> distance between the top of the text margins for the main document and the
         * top of the page for all pages in this section in TWIP.
         * Defaults to 1440. Supports equivalent measurement in pixel, cm or inch.
         */
        top: number

        /**
         * right <Number> distance between the right edge of the page and the right edge of the text
         * extents for this document in TWIP.
         * Defaults to 1800. Supports equivalent measurement in pixel, cm or inch.
         */
        right: number

        /**
         * bottom <Number> distance between the bottom of text margins for the document and the
         * bottom of the page in TWIP.
         * Defaults to 1440. Supports equivalent measurement in pixel, cm or inch.
         */
        bottom: number

        /**
         * left <Number> distance between the left edge of the page and the left edge of the text
         * extents for this document in TWIP.
         * Defaults to 1800. Supports equivalent measurement in pixel, cm or inch.
         */
        left: number
        ...
        /**
         * header <Number> distance from the top edge of the page to the top edge of the
         * header in TWIP.
        ...
        /**
         * footer <Number> distance from the bottom edge of the page to the bottom edge of the
         * footer in TWIP.
         * Defaults to 720. Supports equivalent measurement in pixel, cm or inch.
         */
        footer: number
        ...
        /**
         * gutter <Number> amount of extra space added to the specified margin, above any existing
         * margin values. This setting is typically used when a document is being created for
         * binding in TWIP.
    ...
    export interface DocumentOptions {
         ...
         * Defaults to 22. Supports equivalent measure in pt.
         */
        ...
        /**
         * pageNumber <?Boolean> flag to enable page number in footer. Defaults to false. Page
         * number works only if footer flag is set as true.
         */
        pageNumber?: boolean
     ...
     * @param headerHTMLString <String> clean html string equivalent of header.
     * Defaults to <p></p> if header flag is true.
     * @param documentOptions <DocumentOptions>
     * @param footerHTMLString <String> clean html string equivalent of footer.
