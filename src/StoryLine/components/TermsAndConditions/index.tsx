...
const TermsAndConditions = () => {
    ...
    const handleAgree = () => {
        database.localStorage.set('terms_and_condition', true)
        setOpen(false)
    }

    useEffect(() => {
        database.localStorage.get('terms_and_condition').then((value) => setOpen(!value))
    }, [])
    ...
    return (
        <Dialog
            ...
            maxWidth='lg'
            aria-describedby='tac-description'>
            <DialogTitle id='tac-title' className='text-center'>
                End-User License Agreement (&quot;Agreement&quot;)
            </DialogTitle>
            <DialogContent dividers={true}>
                <DialogContentText id='tac-description' ref={descriptionElementRef} tabIndex={-1}>
                    <p className='text-center font-bold'>Last updated: June 05, 2023</p>
                    <p>
                        Please read this End-User License Agreement carefully before clicking the
                        &quot;I Agree&quot; button or using StoryLine.
                    </p>
                    ...
                    <ul>
                        ...
                        <li>
                            <p>
                                ...
                                the Company downloaded by You to a Device, named StoryLine
                            </p>
                        </li>
                        <li>
                            <p>
                                ...
                                this Agreement) refers to StoryLine.
                            </p>
                        </li>
                        <li>
                            <p>
                    ...
                    <p>
                        ...
                        click on the &quot;I Agree&quot; button, do not use the Application.
                    </p>
                    <p>
                    ...
                    <p>The license that is granted to You by the Company is GPL v3 or later.</p>
                    ...
                    <p>
                        ...
                        aspect thereof. The Company does not assume and shall not have any liability
                    ...
                    <p>
                        ...
                        the Application. Third-party Services and links thereto are provided solely
                        as a convenience to You and You access and use them entirely at your own
                    ...
                    <p>
                        ...
                        Company. The Company may, in its sole discretion, at any time and for any or
                    ...
                    <p>
                        ...
                        the Application will be uninterrupted or error-free; (iii) as to the
                    ...
                    <p>
                        ...
                        applied to the greatest extent enforceable under applicable law. To the
                        extent any warranty exists under law that cannot be disclaimed, the Company
                    ...
                    <p>
                        ...
                        or 100 GBP if You haven't purchased anything through the Application.
                    </p>
                    <p>
                        ...
                        in connection with any provision of this Agreement), even if the Company or
                    ...
                    <h1>United Kingdom Legal Compliance</h1>
                    <p>
                        You represent and warrant that (i) You are not located in a country that is
                        subject to the United Kingdom government embargo, or that has been
                        designated by the United Kingdom government as a &quot;terrorist
                        supporting&quot; country, and (ii) You are not listed on any United Kingdom
                    ...
                    <p>
                        ...
                        use or purchase other Company's services, which the Company will provide to
                        You at the time of such use or purchase.
                    </p>
                    <h1>Contact Us</h1>
                    <p>If you have any questions about this Agreement, You can contact Us:</p>
                    <ul>
                        <li>By email: halcyonshift@gmail.com</li>
                    </ul>
                </DialogContentText>
            </DialogContent>
            <DialogActions>
