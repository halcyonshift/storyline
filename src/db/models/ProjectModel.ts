...
export default class ProjectModel extends Model {
  ...
  @writer async updateProject(data: any) {
    await this.update(project => {
  ...
  @writer async addAnnotation(data: any) {
  ...
  @writer async addCharacter(data: any) {
  ...
  @writer async addLocation(data: any) {
